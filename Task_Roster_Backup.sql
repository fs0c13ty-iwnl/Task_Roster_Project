...
LOCK TABLES `all_accounts` WRITE;
/*!40000 ALTER TABLE `all_accounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `all_accounts` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `announcements` (
  ...
  `managerFirstName` varchar(255) DEFAULT NULL,
  `managerLastName` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-12 14:15:19
